...
projects[ding2][download][tag] = "7.x-2.5.0"

; WAYF support in alma.
;;projects[ding2][patch][] = "https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/alma-wayf.diff"
; Fix system block code AAKBET-98 in alma
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/alma-blockcode.diff'

; WAYF support (keept to not forget them).
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ddbasic-wayf.diff'
; Place2book fix (keept to not forget them).
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ddbasic-place2book.diff'
; Opening hours fixes (keept to not forget them).
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ddbasic-opening-hours.diff'
; The patches above with re-compiled css and minified JS.
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ddbasic-combined.diff'

; Add WAYF support in ding_frontend.
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_frontend-wayf.diff'

; Remove un-used webtrends plugins.
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_webtrends-unused-plugin.diff'

; Opening hours in ding_library.
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_library-opening-hours.diff'

; Override node options permissions.
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_perm-override-node.diff'
; Adv. user permissions.
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_perm-adv-user.diff'
; Aakb survery permissions
;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_perm-aakb-survey.diff'
; The patches above combined.
;;projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:feature/ding_perm-combined.diff'
...
projects[ding2][patch][] = 'https://github.com/ding2/ding2/compare/7.x-2.5.0...aakbcms:combined.diff'
...
projects[ding_wayf_dk][download][tag] = "7.x-2.5.0"
...
projects[opening_hours][patch][] = "https://www.drupal.org/files/issues/opening_hours-view_modes-1054616-5.patch"
...
projects[aakb_alters][download][tag] = "7.x-2.5.0"
...
projects[aakb_survey][download][tag] = "7.x-2.5.0"
